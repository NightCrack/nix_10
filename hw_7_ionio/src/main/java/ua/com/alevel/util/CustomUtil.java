...
public final class CustomUtil {
    ...
    public static boolean checkUniqueName(List<String> existingNamesArray, String nameToCheck) {
        for (String name : existingNamesArray) {
    ...
    public static boolean checkUniqueId(List<Long> ids, Long idToCheck) {
        for (Long id : ids) {
    ...
    public static String getRandomString(List<String> stringArray) {
        String returnValue = stringArray.get((int) ((stringArray.size() - 1) * Math.random()));
        return returnValue;
    }

    public static Long getRandomLong(List<Long> longArray) {
        Long returnValue = longArray.get((int) ((longArray.size() - 1) * Math.random()));
        return returnValue;
    }

...
public class ReversingApp {
    ...
    private static void menu(int input) {
        switch (input) {
            case 1:
                System.out.print(System.lineSeparator() + "Your input: ");
                break;
            case 2:
                System.out.print(System.lineSeparator() + "Your compartment (first or general) (criteria or index): ");
                break;
            case 3:
                System.out.print(System.lineSeparator() + "Your last compartment criteria (or index): ");
                break;
            case 4:
                System.out.print(System.lineSeparator() + "Are your criteria indexes (true or false; default - false)?: ");
                break;
            default:

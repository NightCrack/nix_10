use jdbc;
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Christian', 'Bauer', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Gavin', 'King', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Gary', 'Gregory', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Bruce', 'Eckel', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Brian', 'Goetz', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Tim', 'Peierls', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Joshua', 'Bloch', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Joseph', 'Bowbeer', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'David', 'Holmes', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Doug', 'Lea', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Raoul-Gabriel', 'Urma', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Mario', 'Fusco', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Alan', 'Mycroft', -9223372036854775808, -9223372036854775808);
insert into authors values (null, current_timestamp(), current_timestamp(), true, 'Scott', 'Oaks', -9223372036854775808, -9223372036854775808);

insert into genres values (null, current_timestamp(), current_timestamp(), true, 'Undefined');
...
current_timestamp(),
true,
'https://balka-book.com/files/2021/05_03/21_33/u_files_store_1_487055.jpg',
'Java Persistence with Hibernate. 2-end edition',
...
current_timestamp(),
true,
'https://balka-book.com/files/2021/05_03/21_34/u_files_store_1_490060.jpg',
'Thinking in Java (4th Edition)',
UNIX_TIMESTAMP('2006-01-01')*1000,
1150,
...
current_timestamp(),
true,
'https://balka-book.com/files/2021/05_03/21_28/u_files_store_1_472075.jpg',
...
current_timestamp(),
true,
'https://balka-book.com/files/2021/05_03/21_27/u_files_store_1_468120.jpg',
'Effective Java. 3rd Edition',
UNIX_TIMESTAMP('2018-01-01')*1000,
392,
...
current_timestamp(),
true,
'https://balka-book.com/files/2021/05_03/21_28/u_files_store_1_472037.jpg',
'Java 8 in Action. Lambdas, Streams, and functional-style programming',
UNIX_TIMESTAMP('2015-01-01')*1000,
394,
'Summary
...
current_timestamp(),
true,
'https://balka-book.com/files/2021/05_03/21_54/u_files_store_1_559706.jpg',
'Java Performance: In-Depth Advice for Tuning and Programming Java 8, 11, and Beyond 2nd Edition',
UNIX_TIMESTAMP('2020-01-01')*1000,
450,
...
current_timestamp(),
true,
'https://balka-book.com/files/2021/05_03/21_42/u_files_store_1_517038.jpg',
'Java Performance: The Definitive Guide: Getting the Most Out of Your Code 1st Edition',
UNIX_TIMESTAMP('2014-01-01')*1000,
426,
...
insert into author_book values (1, '978-1617290459');
insert into author_book values (2, '978-1617290459');
insert into author_book values (3, '978-1617290459');
insert into author_book values (4, '978-8131705575');
insert into author_book values (5, '978-0321349606');
insert into author_book values (6, '978-0321349606');
insert into author_book values (7, '978-0321349606');
insert into author_book values (8, '978-0321349606');
insert into author_book values (9, '978-0321349606');
insert into author_book values (10, '978-0321349606');
insert into author_book values (7, '978-0134685991');
insert into author_book values (11, '9781617291999');
insert into author_book values (12, '9781617291999');
insert into author_book values (13, '9781617291999');
insert into author_book values (14, '9781492056119');
insert into author_book values (14, '978-1449358457');

insert into genre_book values (1, '978-1617290459');
insert into genre_book values (1, '978-8131705575');
insert into genre_book values (1, '978-0321349606');
insert into genre_book values (1, '978-0134685991');
insert into genre_book values (1, '9781617291999');
insert into genre_book values (1, '9781492056119');
insert into genre_book values (1, '978-1449358457');
